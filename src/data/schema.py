...
CUSTOMER_SCHEMA = DataFrameSchema(
    {
        ...
        "tenure": Column(pa.Int, Check.ge(0), nullable=False),
        ...
        "OnlineSecurity": Column(pa.String, nullable=False),
        "OnlineBackup": Column(pa.String,  nullable=False),
        "DeviceProtection": Column(pa.String,  nullable=False),
        "TechSupport": Column(pa.String,  nullable=False),
        "StreamingTV": Column(pa.String,  nullable=False),
        "StreamingMovies": Column(pa.String,  nullable=False),
        ...
        "MonthlyCharges": Column(pa.Float, Check.ge(0.0), nullable=False),
        "TotalCharges": Column(pa.Float, Check.ge(0.0), nullable=True),
